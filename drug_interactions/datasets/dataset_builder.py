...
from drug_interactions.datasets.CharVecDataset import CharVecDrugDataset
...
def get_dataset(data_type: DatasetTypes, old_drug_bank: DrugBank,
    ...
    elif data_type == DatasetTypes.CHAR_2_VEC:
        data = CharVecDrugDataset(old_drug_bank, new_drug_bank, neg_pos_ratio, **kwargs).build_dataset()
